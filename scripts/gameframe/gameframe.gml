// Generated at 2024-10-15 18:33:21 (2295ms) for v2.3.7+
/// @lint nullToAny true
// Feather disable all
#region prototypes
...
function gameframe_caption_draw_caption_text_default(__x, __y, __width, __height) {
	...
	var __oldColor = draw_get_color();
	draw_set_color(gameframe_caption_text_color);
...
globalvar gameframe_caption_text_color; /// @is {int}
gameframe_caption_text_color = 16777215;
